...
describe('YAML Validation Functions', () => {
  ...
  describe('validateApplicationData', () => {
    ...
    it('should warn about unknown categories', () => {
      ...
      const result = validateApplicationData(dataWithUnknownCategory, 'test.yaml');
    ...
    it('should validate install methods', () => {
      ...
      const result = validateApplicationData(dataWithInvalidMethod, 'test.yaml');
      expect(consoleSpy.warn).toHaveBeenCalledWith(
    ...
    it('should validate alternatives array', () => {
      ...
      const result = validateApplicationData(dataWithInvalidAlternatives, 'test.yaml');
      expect(consoleSpy.warn).toHaveBeenCalledWith(
