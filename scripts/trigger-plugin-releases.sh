...
# Find all plugins
plugins=($(find "$PROJECT_ROOT/packages" -mindepth 1 -maxdepth 1 -type d -name 'tool-*' -o -name 'desktop-*' -o -name 'package-manager-*' | xargs -I {} basename {}))
...
for plugin in "${plugins[@]}"; do
    ...
    plugin_path="$PROJECT_ROOT/packages/$plugin"
