...
function StatCard({ title, count, description, href }: {
  title: string;
  count: number;
  description: string;
  href?: string;
  ...
  const content = (
    <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
      ...
      <div className="text-3xl font-bold text-blue-600 mb-1">{count.toLocaleString()}</div>
...
function CategoryBreakdown({ title, categories }: {
  title: string;
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">DevEx Registry</h1>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Overview Stats */}
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Registry Overview</h2>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="space-y-4">
              <div className="border-b pb-4">
                <h3 className="text-lg font-semibold text-gray-800">Full Registry</h3>
                <p className="text-gray-600 mb-2">Get complete registry data including all applications, plugins, configs, and stacks</p>
                <code className="bg-gray-100 px-3 py-1 rounded text-sm">GET /api/v1/registry</code>
              </div>
              <div className="border-b pb-4">
                <h3 className="text-lg font-semibold text-gray-800">Applications</h3>
                <p className="text-gray-600 mb-2">Browse applications with filtering by category, platform, and search</p>
                <code className="bg-gray-100 px-3 py-1 rounded text-sm">GET /api/v1/applications?category=development&platform=linux</code>
              </div>
              <div className="border-b pb-4">
                <h3 className="text-lg font-semibold text-gray-800">Plugins</h3>
                <p className="text-gray-600 mb-2">Browse DevEx CLI plugins with filtering by type and search</p>
                <code className="bg-gray-100 px-3 py-1 rounded text-sm">GET /api/v1/plugins?type=package-manager</code>
              </div>
              <div>
                <h3 className="text-lg font-semibold text-gray-800">Statistics</h3>
                <p className="text-gray-600 mb-2">Get comprehensive registry statistics and metrics</p>
                <code className="bg-gray-100 px-3 py-1 rounded text-sm">GET /api/v1/stats</code>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center">
            ...
            <p className="text-gray-500 mt-2">
              Powered by <Link href="https://devex.sh" className="text-blue-600 hover:text-blue-800">DevEx CLI</Link>
            </p>
          </div>
        </div>
      </footer>
