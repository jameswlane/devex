...
func NewInstallerError(errorType ErrorType, installer, packageName string) *InstallerError {
...
// NewInstallerErrorWithMessage creates a new installer error with a custom message
func NewInstallerErrorWithMessage(errorType ErrorType, installer, packageName, message string) *InstallerError {
	return &InstallerError{
		Type:      errorType,
		Installer: installer,
		Package:   packageName,
