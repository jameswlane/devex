...
func applyTemplate(template templates.Template, settings config.CrossPlatformSettings, platformInfo platform.Platform, customize bool, reader *bufio.Reader, green, yellow, cyan func(...interface{}) string) error {
	configDir := settings.GetConfigDir()
...
func generateConfigFromTemplate(template templates.Template, configDir string, platformInfo platform.Platform) error {
...
func createDesktopConfig(template templates.Template, configDir string, platformInfo platform.Platform) error {
...
func createMetadataConfig(template templates.Template, configDir string, platformInfo platform.Platform) error {
	metadata := struct {
		Template templates.TemplateMetadata `yaml:"template"`
		Platform platform.Platform          `yaml:"platform"`
